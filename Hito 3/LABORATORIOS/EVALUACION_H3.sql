...
--nombres que comience con S y apellido termine con s
...
--mayores a 20, equ-333, sede el alto
...
id_jugador varchar(20),
 ...
 insert into Premios(nombre_campeonato, id_equipo,nombre_equipo, sede, posicion) values('Campeonato Unifranz', 'equ-111', 'Google','El Alto',1),('Campeonato Unifranz', 'equ-333', 'girls unifranz','El Alto',2)
